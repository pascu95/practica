...
"true");
document.querySelector('.project3').removeAttribute("tabindex");
document.querySelector('.project3-container').removeAttribute("ariahidden")
break;
case -540:
...
function clickLeft() {
  switch (newValue){
    ...
    break;
    case 0:
    document.querySelector('.project3').setAttribute("tabindex", "-1");
    document.querySelector('.project3-container').setAttribute("ariahidden",
    "true");
